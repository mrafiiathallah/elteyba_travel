          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input 
                ...
                className="px-4 py-2 rounded-xl focus:outline-none text-gray-800"
              />
              <button 
                type="submit" 
                className="border-transparent border-2 bg-accent hover:bg-transparent hover:text-accent hover:border-accent text-white font-semibold px-8 py-2 rounded-3xl transition duration-300"
              >
                Subscribe
              </button>
            </form>
